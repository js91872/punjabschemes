  ...
  return (
    <footer className="site-footer">
      <div className="container footer-inner">
        ...
        <div><strong>Information</strong><nav aria-label="Information"><Link href="/about">About</Link><Link href="/contact">Contact</Link><Link href="/disclaimer">Disclaimer</Link><Link href="/privacy-policy">Privacy</Link></nav></div>
      </div>
