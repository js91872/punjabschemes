  ...
  return (
    <footer className="site-footer">
      <div className="container footer-inner">
        <div><Link className="footer-brand" href="/"><Image src="/brand/punjab-schemes-mark.svg" alt="" width={42} height={42} /><span>Punjab Schemes</span></Link><p>Making Punjab welfare information easier to understand.</p></div>
